...
import com.dicoding.rifqi.storyapp.databinding.ActivityCameraBinding
...
class CameraActivity : AppCompatActivity() {
    ...
    private fun takePhoto() {
        ...
        val photoFile = com.dicoding.rifqi.storyapp.ui.createFile(application)
        ...
        imageCapture.takePicture( outputOptions, ContextCompat.getMainExecutor(this),
            object : ImageCapture.OnImageSavedCallback {
                ...
                override fun onError(exc: ImageCaptureException) {
                    Toast.makeText(
                        this@CameraActivity,
                        resources.getString(R.string.failed_take_a_photo), Toast.LENGTH_SHORT
                    ).show()
                }
    ...
    private fun startCamera() {
        ...
        cameraProviderFuture.addListener({
            ...
            val preview = Preview.Builder()
                .build()
                .also {
                    it.setSurfaceProvider(activityCameraBinding.viewCamera.surfaceProvider)
                }
